...
assert.match(process.env.npm_config_user_agent ?? "", /^npm\/11\.19\.0 /, "Use npm 11.19.0");
...
assert.match(rust, /^host: x86_64-pc-windows-msvc$/m, "Use the Windows x64 MSVC toolchain");
assert.match(cargo, /^cargo 1\.97\.1 /, "Use Cargo 1.97.1");
console.log("Toolchain PASS: Node 24.20.0, npm 11.19.0, Rust/Cargo 1.97.1, Windows x64 MSVC");
